...
Version  : 1.27.67
Release  : 1199
URL      : https://github.com/boto/botocore/archive/1.27.67/botocore-1.27.67.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.67/botocore-1.27.67.tar.gz
...
%prep
%setup -q -n botocore-1.27.67
cd %{_builddir}/botocore-1.27.67
pushd ..
cp -a botocore-1.27.67 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662494015
