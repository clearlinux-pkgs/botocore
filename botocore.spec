...
Version  : 1.31.9
Release  : 1415
URL      : https://github.com/boto/botocore/archive/1.31.9/botocore-1.31.9.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.9/botocore-1.31.9.tar.gz
...
%prep
%setup -q -n botocore-1.31.9
cd %{_builddir}/botocore-1.31.9
pushd ..
cp -a botocore-1.31.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689979806
