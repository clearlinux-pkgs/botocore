...
Version  : 1.34.17
Release  : 1534
URL      : https://github.com/boto/botocore/archive/1.34.17/botocore-1.34.17.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.17/botocore-1.34.17.tar.gz
...
%prep
%setup -q -n botocore-1.34.17
cd %{_builddir}/botocore-1.34.17
pushd ..
cp -a botocore-1.34.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705006187
