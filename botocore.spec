...
Version  : 1.31.24
Release  : 1430
URL      : https://github.com/boto/botocore/archive/1.31.24/botocore-1.31.24.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.24/botocore-1.31.24.tar.gz
...
%prep
%setup -q -n botocore-1.31.24
cd %{_builddir}/botocore-1.31.24
pushd ..
cp -a botocore-1.31.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691707599
