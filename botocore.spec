...
Version  : 1.34.95
Release  : 1612
URL      : https://github.com/boto/botocore/archive/1.34.95/botocore-1.34.95.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.95/botocore-1.34.95.tar.gz
...
%prep
%setup -q -n botocore-1.34.95
cd %{_builddir}/botocore-1.34.95
pushd ..
cp -a botocore-1.34.95 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714507137
