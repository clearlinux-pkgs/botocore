...
Source0  : https://github.com/boto/botocore/archive/1.29.100/botocore-1.29.100.tar.gz
...
%prep
%setup -q -n botocore-1.29.100
cd %{_builddir}/botocore-1.29.100
pushd ..
cp -a botocore-1.29.100 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679946439
