...
Version  : 1.29.99
Release  : 1337
URL      : https://github.com/boto/botocore/archive/1.29.99/botocore-1.29.99.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.99/botocore-1.29.99.tar.gz
...
%prep
%setup -q -n botocore-1.29.99
cd %{_builddir}/botocore-1.29.99
pushd ..
cp -a botocore-1.29.99 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679930926
