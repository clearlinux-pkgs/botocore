...
Version  : 1.29.58
Release  : 1295
URL      : https://github.com/boto/botocore/archive/1.29.58/botocore-1.29.58.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.58/botocore-1.29.58.tar.gz
...
%prep
%setup -q -n botocore-1.29.58
cd %{_builddir}/botocore-1.29.58
pushd ..
cp -a botocore-1.29.58 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674766120
