...
Source0  : https://github.com/boto/botocore/archive/1.36.21/botocore-1.36.21.tar.gz
...
%prep
%setup -q -n botocore-1.36.21
cd %{_builddir}/botocore-1.36.21
pushd ..
cp -a botocore-1.36.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739566182
