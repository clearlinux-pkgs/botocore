...
Version  : 1.35.22
Release  : 1704
URL      : https://github.com/boto/botocore/archive/1.35.22/botocore-1.35.22.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.22/botocore-1.35.22.tar.gz
...
%prep
%setup -q -n botocore-1.35.22
cd %{_builddir}/botocore-1.35.22
pushd ..
cp -a botocore-1.35.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726689073
