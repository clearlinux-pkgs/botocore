...
Version  : 1.36.23
Release  : 1799
URL      : https://github.com/boto/botocore/archive/1.36.23/botocore-1.36.23.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.36.23/botocore-1.36.23.tar.gz
...
%prep
%setup -q -n botocore-1.36.23
cd %{_builddir}/botocore-1.36.23
pushd ..
cp -a botocore-1.36.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739913611
