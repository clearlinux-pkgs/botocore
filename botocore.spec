...
Version  : 1.35.28
Release  : 1712
URL      : https://github.com/boto/botocore/archive/1.35.28/botocore-1.35.28.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.28/botocore-1.35.28.tar.gz
...
%prep
%setup -q -n botocore-1.35.28
cd %{_builddir}/botocore-1.35.28
pushd ..
cp -a botocore-1.35.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727385019
