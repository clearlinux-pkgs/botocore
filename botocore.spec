...
Version  : 1.27.93
Release  : 1225
URL      : https://github.com/boto/botocore/archive/1.27.93/botocore-1.27.93.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.93/botocore-1.27.93.tar.gz
...
%prep
%setup -q -n botocore-1.27.93
cd %{_builddir}/botocore-1.27.93
pushd ..
cp -a botocore-1.27.93 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666122788
