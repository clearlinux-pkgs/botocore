...
Version  : 1.29.149
Release  : 1387
URL      : https://github.com/boto/botocore/archive/1.29.149/botocore-1.29.149.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.149/botocore-1.29.149.tar.gz
...
%prep
%setup -q -n botocore-1.29.149
cd %{_builddir}/botocore-1.29.149
pushd ..
cp -a botocore-1.29.149 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686178616
