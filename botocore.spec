...
Version  : 1.29.158
Release  : 1396
URL      : https://github.com/boto/botocore/archive/1.29.158/botocore-1.29.158.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.158/botocore-1.29.158.tar.gz
...
%prep
%setup -q -n botocore-1.29.158
cd %{_builddir}/botocore-1.29.158
pushd ..
cp -a botocore-1.29.158 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687376691
