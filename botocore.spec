...
Version  : 1.38.36
Release  : 1875
URL      : https://github.com/boto/botocore/archive/1.38.36/botocore-1.38.36.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.36/botocore-1.38.36.tar.gz
...
%prep
%setup -q -n botocore-1.38.36
cd %{_builddir}/botocore-1.38.36
pushd ..
cp -a botocore-1.38.36 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749758092
