...
Version  : 1.35.97
Release  : 1773
URL      : https://github.com/boto/botocore/archive/1.35.97/botocore-1.35.97.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.97/botocore-1.35.97.tar.gz
...
%prep
%setup -q -n botocore-1.35.97
cd %{_builddir}/botocore-1.35.97
pushd ..
cp -a botocore-1.35.97 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736543143
