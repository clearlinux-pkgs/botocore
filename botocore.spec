...
Version  : 1.34.100
Release  : 1617
URL      : https://github.com/boto/botocore/archive/1.34.100/botocore-1.34.100.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.100/botocore-1.34.100.tar.gz
...
%prep
%setup -q -n botocore-1.34.100
cd %{_builddir}/botocore-1.34.100
pushd ..
cp -a botocore-1.34.100 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715111895
