...
Version  : 1.38.31
Release  : 1871
URL      : https://github.com/boto/botocore/archive/1.38.31/botocore-1.38.31.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.31/botocore-1.38.31.tar.gz
...
%prep
%setup -q -n botocore-1.38.31
cd %{_builddir}/botocore-1.38.31
pushd ..
cp -a botocore-1.38.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749164097
