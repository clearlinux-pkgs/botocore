...
Version  : 1.31.39
Release  : 1445
URL      : https://github.com/boto/botocore/archive/1.31.39/botocore-1.31.39.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.39/botocore-1.31.39.tar.gz
...
%prep
%setup -q -n botocore-1.31.39
cd %{_builddir}/botocore-1.31.39
pushd ..
cp -a botocore-1.31.39 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693522737
