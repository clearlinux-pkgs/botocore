...
Version  : 1.29.33
Release  : 1270
URL      : https://github.com/boto/botocore/archive/1.29.33/botocore-1.29.33.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.33/botocore-1.29.33.tar.gz
...
%prep
%setup -q -n botocore-1.29.33
cd %{_builddir}/botocore-1.29.33
pushd ..
cp -a botocore-1.29.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671484800
