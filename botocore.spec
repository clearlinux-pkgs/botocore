...
Version  : 1.29.133
Release  : 1371
URL      : https://github.com/boto/botocore/archive/1.29.133/botocore-1.29.133.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.133/botocore-1.29.133.tar.gz
...
%prep
%setup -q -n botocore-1.29.133
cd %{_builddir}/botocore-1.29.133
pushd ..
cp -a botocore-1.29.133 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683834938
