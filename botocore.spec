...
Version  : 1.34.160
Release  : 1677
URL      : https://github.com/boto/botocore/archive/1.34.160/botocore-1.34.160.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.160/botocore-1.34.160.tar.gz
...
%prep
%setup -q -n botocore-1.34.160
cd %{_builddir}/botocore-1.34.160
pushd ..
cp -a botocore-1.34.160 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723579729
