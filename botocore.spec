...
Source0  : https://github.com/boto/botocore/archive/1.12.25.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0 LGPL-2.1 MIT
Requires: botocore-data = %{version}-%{release}
...
%package data
Summary: data components for the botocore package.
Group: Data

%description data
data components for the botocore package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1539730855
