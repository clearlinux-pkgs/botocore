...
Version  : 1.29.53
Release  : 1290
URL      : https://github.com/boto/botocore/archive/1.29.53/botocore-1.29.53.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.53/botocore-1.29.53.tar.gz
...
%prep
%setup -q -n botocore-1.29.53
cd %{_builddir}/botocore-1.29.53
pushd ..
cp -a botocore-1.29.53 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674171898
