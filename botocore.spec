...
Source0  : https://github.com/boto/botocore/archive/1.37.29/botocore-1.37.29.tar.gz
...
%prep
%setup -q -n botocore-1.37.29
cd %{_builddir}/botocore-1.37.29
pushd ..
cp -a botocore-1.37.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744066325
