...
Source0  : https://github.com/boto/botocore/archive/1.34.94/botocore-1.34.94.tar.gz
...
%prep
%setup -q -n botocore-1.34.94
cd %{_builddir}/botocore-1.34.94
pushd ..
cp -a botocore-1.34.94 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714420655
