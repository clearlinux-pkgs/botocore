...
Version  : 1.27.40
Release  : 1169
URL      : https://github.com/boto/botocore/archive/1.27.40/botocore-1.27.40.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.40/botocore-1.27.40.tar.gz
...
%prep
%setup -q -n botocore-1.27.40
cd %{_builddir}/botocore-1.27.40
pushd ..
cp -a botocore-1.27.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659038056
