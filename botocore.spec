...
Version  : 1.35.75
Release  : 1759
URL      : https://github.com/boto/botocore/archive/1.35.75/botocore-1.35.75.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.75/botocore-1.35.75.tar.gz
...
%prep
%setup -q -n botocore-1.35.75
cd %{_builddir}/botocore-1.35.75
pushd ..
cp -a botocore-1.35.75 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733345921
