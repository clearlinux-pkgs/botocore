...
Version  : 1.27.94
Release  : 1226
URL      : https://github.com/boto/botocore/archive/1.27.94/botocore-1.27.94.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.94/botocore-1.27.94.tar.gz
...
%prep
%setup -q -n botocore-1.27.94
cd %{_builddir}/botocore-1.27.94
pushd ..
cp -a botocore-1.27.94 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666209320
