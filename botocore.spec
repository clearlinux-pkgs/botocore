...
Version  : 1.38.21
Release  : 1861
URL      : https://github.com/boto/botocore/archive/1.38.21/botocore-1.38.21.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.21/botocore-1.38.21.tar.gz
...
%prep
%setup -q -n botocore-1.38.21
cd %{_builddir}/botocore-1.38.21
pushd ..
cp -a botocore-1.38.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747857913
