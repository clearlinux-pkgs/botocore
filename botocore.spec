...
Version  : 1.36.25
Release  : 1801
URL      : https://github.com/boto/botocore/archive/1.36.25/botocore-1.36.25.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.36.25/botocore-1.36.25.tar.gz
...
%prep
%setup -q -n botocore-1.36.25
cd %{_builddir}/botocore-1.36.25
pushd ..
cp -a botocore-1.36.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740084249
