...
Version  : 1.38.9
Release  : 1849
URL      : https://github.com/boto/botocore/archive/1.38.9/botocore-1.38.9.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.9/botocore-1.38.9.tar.gz
...
%prep
%setup -q -n botocore-1.38.9
cd %{_builddir}/botocore-1.38.9
pushd ..
cp -a botocore-1.38.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746474129
