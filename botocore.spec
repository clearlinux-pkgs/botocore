...
Version  : 1.38.35
Release  : 1874
URL      : https://github.com/boto/botocore/archive/1.38.35/botocore-1.38.35.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.35/botocore-1.38.35.tar.gz
...
%prep
%setup -q -n botocore-1.38.35
cd %{_builddir}/botocore-1.38.35
pushd ..
cp -a botocore-1.38.35 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749671837
