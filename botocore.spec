...
Version  : 1.34.152
Release  : 1669
URL      : https://github.com/boto/botocore/archive/1.34.152/botocore-1.34.152.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.152/botocore-1.34.152.tar.gz
...
%prep
%setup -q -n botocore-1.34.152
cd %{_builddir}/botocore-1.34.152
pushd ..
cp -a botocore-1.34.152 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722541812
