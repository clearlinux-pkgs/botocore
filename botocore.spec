...
Version  : 1.29.38
Release  : 1275
URL      : https://github.com/boto/botocore/archive/1.29.38/botocore-1.29.38.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.38/botocore-1.29.38.tar.gz
...
%prep
%setup -q -n botocore-1.29.38
cd %{_builddir}/botocore-1.29.38
pushd ..
cp -a botocore-1.29.38 buildavx2
cp -a botocore-1.29.38 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672174824
