...
Source0  : https://github.com/boto/botocore/archive/1.37.35/botocore-1.37.35.tar.gz
...
%prep
%setup -q -n botocore-1.37.35
cd %{_builddir}/botocore-1.37.35
pushd ..
cp -a botocore-1.37.35 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744833505
