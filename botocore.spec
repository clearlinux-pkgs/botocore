...
Version  : 1.34.140
Release  : 1657
URL      : https://github.com/boto/botocore/archive/1.34.140/botocore-1.34.140.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.140/botocore-1.34.140.tar.gz
...
%prep
%setup -q -n botocore-1.34.140
cd %{_builddir}/botocore-1.34.140
pushd ..
cp -a botocore-1.34.140 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720209506
