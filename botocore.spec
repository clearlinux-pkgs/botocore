...
Version  : 1.38.14
Release  : 1854
URL      : https://github.com/boto/botocore/archive/1.38.14/botocore-1.38.14.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.14/botocore-1.38.14.tar.gz
...
%prep
%setup -q -n botocore-1.38.14
cd %{_builddir}/botocore-1.38.14
pushd ..
cp -a botocore-1.38.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747080826
