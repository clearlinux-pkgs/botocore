...
Version  : 1.34.9
Release  : 1526
URL      : https://github.com/boto/botocore/archive/1.34.9/botocore-1.34.9.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.9/botocore-1.34.9.tar.gz
...
%prep
%setup -q -n botocore-1.34.9
cd %{_builddir}/botocore-1.34.9
pushd ..
cp -a botocore-1.34.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703710985
