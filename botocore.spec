...
Version  : 1.34.103
Release  : 1620
URL      : https://github.com/boto/botocore/archive/1.34.103/botocore-1.34.103.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.103/botocore-1.34.103.tar.gz
...
%prep
%setup -q -n botocore-1.34.103
cd %{_builddir}/botocore-1.34.103
pushd ..
cp -a botocore-1.34.103 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715612531
