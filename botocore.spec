...
Version  : 1.29.162
Release  : 1400
URL      : https://github.com/boto/botocore/archive/1.29.162/botocore-1.29.162.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.162/botocore-1.29.162.tar.gz
...
%prep
%setup -q -n botocore-1.29.162
cd %{_builddir}/botocore-1.29.162
pushd ..
cp -a botocore-1.29.162 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687907079
