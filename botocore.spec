...
Version  : 1.34.117
Release  : 1634
URL      : https://github.com/boto/botocore/archive/1.34.117/botocore-1.34.117.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.117/botocore-1.34.117.tar.gz
...
%prep
%setup -q -n botocore-1.34.117
cd %{_builddir}/botocore-1.34.117
pushd ..
cp -a botocore-1.34.117 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717425321
