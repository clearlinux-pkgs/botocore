...
Version  : 1.27.82
Release  : 1214
URL      : https://github.com/boto/botocore/archive/1.27.82/botocore-1.27.82.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.82/botocore-1.27.82.tar.gz
...
%prep
%setup -q -n botocore-1.27.82
cd %{_builddir}/botocore-1.27.82
pushd ..
cp -a botocore-1.27.82 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664308502
