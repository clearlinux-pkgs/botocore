...
Version  : 1.38.39
Release  : 1878
URL      : https://github.com/boto/botocore/archive/1.38.39/botocore-1.38.39.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.39/botocore-1.38.39.tar.gz
...
%prep
%setup -q -n botocore-1.38.39
cd %{_builddir}/botocore-1.38.39
pushd ..
cp -a botocore-1.38.39 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750286692
