...
Version  : 1.29.126
Release  : 1364
URL      : https://github.com/boto/botocore/archive/1.29.126/botocore-1.29.126.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.126/botocore-1.29.126.tar.gz
...
%prep
%setup -q -n botocore-1.29.126
cd %{_builddir}/botocore-1.29.126
pushd ..
cp -a botocore-1.29.126 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683144152
