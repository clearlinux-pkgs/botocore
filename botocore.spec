...
Version  : 1.29.35
Release  : 1272
URL      : https://github.com/boto/botocore/archive/1.29.35/botocore-1.29.35.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.35/botocore-1.29.35.tar.gz
...
%prep
%setup -q -n botocore-1.29.35
cd %{_builddir}/botocore-1.29.35
pushd ..
cp -a botocore-1.29.35 buildavx2
cp -a botocore-1.29.35 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671666071
