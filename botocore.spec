...
Version  : 1.32.0
Release  : 1495
URL      : https://github.com/boto/botocore/archive/1.32.0/botocore-1.32.0.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.32.0/botocore-1.32.0.tar.gz
...
%prep
%setup -q -n botocore-1.32.0
cd %{_builddir}/botocore-1.32.0
pushd ..
cp -a botocore-1.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700005402
