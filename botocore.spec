...
Version  : 1.29.130
Release  : 1368
URL      : https://github.com/boto/botocore/archive/1.29.130/botocore-1.29.130.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.130/botocore-1.29.130.tar.gz
...
%prep
%setup -q -n botocore-1.29.130
cd %{_builddir}/botocore-1.29.130
pushd ..
cp -a botocore-1.29.130 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683577015
