...
Source0  : https://github.com/boto/botocore/archive/1.29.69/botocore-1.29.69.tar.gz
...
%prep
%setup -q -n botocore-1.29.69
cd %{_builddir}/botocore-1.29.69
pushd ..
cp -a botocore-1.29.69 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676062065
