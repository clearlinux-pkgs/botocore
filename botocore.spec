...
Version  : 1.29.127
Release  : 1365
URL      : https://github.com/boto/botocore/archive/1.29.127/botocore-1.29.127.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.127/botocore-1.29.127.tar.gz
...
%prep
%setup -q -n botocore-1.29.127
cd %{_builddir}/botocore-1.29.127
pushd ..
cp -a botocore-1.29.127 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683240403
