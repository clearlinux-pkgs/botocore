...
Version  : 1.34.141
Release  : 1658
URL      : https://github.com/boto/botocore/archive/1.34.141/botocore-1.34.141.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.141/botocore-1.34.141.tar.gz
...
%prep
%setup -q -n botocore-1.34.141
cd %{_builddir}/botocore-1.34.141
pushd ..
cp -a botocore-1.34.141 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720469900
