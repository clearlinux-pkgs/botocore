...
Version  : 1.34.102
Release  : 1619
URL      : https://github.com/boto/botocore/archive/1.34.102/botocore-1.34.102.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.102/botocore-1.34.102.tar.gz
...
%prep
%setup -q -n botocore-1.34.102
cd %{_builddir}/botocore-1.34.102
pushd ..
cp -a botocore-1.34.102 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715316393
