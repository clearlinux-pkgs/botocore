...
Version  : 1.24.1
Release  : 1056
URL      : https://github.com/boto/botocore/archive/1.24.1/botocore-1.24.1.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.24.1/botocore-1.24.1.tar.gz
...
%prep
%setup -q -n botocore-1.24.1
cd %{_builddir}/botocore-1.24.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645046483
...
cp %{_builddir}/botocore-1.24.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/botocore/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/botocore-1.24.1/NOTICE %{buildroot}/usr/share/package-licenses/botocore/d7a178c24429fa0e1bb6f6375b0db31677f1ac19
cp %{_builddir}/botocore-1.24.1/tests/unit/auth/aws4_testsuite/LICENSE %{buildroot}/usr/share/package-licenses/botocore/2b8b815229aa8a61e483fb4ba0588b8b6c491890
