...
Version  : 1.34.86
Release  : 1603
URL      : https://github.com/boto/botocore/archive/1.34.86/botocore-1.34.86.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.86/botocore-1.34.86.tar.gz
...
%prep
%setup -q -n botocore-1.34.86
cd %{_builddir}/botocore-1.34.86
pushd ..
cp -a botocore-1.34.86 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713383139
