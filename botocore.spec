...
Version  : 1.29.117
Release  : 1355
URL      : https://github.com/boto/botocore/archive/1.29.117/botocore-1.29.117.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.117/botocore-1.29.117.tar.gz
...
%prep
%setup -q -n botocore-1.29.117
cd %{_builddir}/botocore-1.29.117
pushd ..
cp -a botocore-1.29.117 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682020818
