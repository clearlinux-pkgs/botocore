...
Version  : 1.34.150
Release  : 1667
URL      : https://github.com/boto/botocore/archive/1.34.150/botocore-1.34.150.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.150/botocore-1.34.150.tar.gz
...
%prep
%setup -q -n botocore-1.34.150
cd %{_builddir}/botocore-1.34.150
pushd ..
cp -a botocore-1.34.150 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722293728
