...
Version  : 1.29.112
Release  : 1350
URL      : https://github.com/boto/botocore/archive/1.29.112/botocore-1.29.112.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.112/botocore-1.29.112.tar.gz
...
%prep
%setup -q -n botocore-1.29.112
cd %{_builddir}/botocore-1.29.112
pushd ..
cp -a botocore-1.29.112 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681339987
