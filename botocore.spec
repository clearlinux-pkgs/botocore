...
Version  : 1.27.72
Release  : 1204
URL      : https://github.com/boto/botocore/archive/1.27.72/botocore-1.27.72.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.72/botocore-1.27.72.tar.gz
...
%prep
%setup -q -n botocore-1.27.72
cd %{_builddir}/botocore-1.27.72
pushd ..
cp -a botocore-1.27.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663098876
