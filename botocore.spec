...
Version  : 1.34.21
Release  : 1538
URL      : https://github.com/boto/botocore/archive/1.34.21/botocore-1.34.21.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.21/botocore-1.34.21.tar.gz
...
%prep
%setup -q -n botocore-1.34.21
cd %{_builddir}/botocore-1.34.21
pushd ..
cp -a botocore-1.34.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705525429
