...
Version  : 1.34.120
Release  : 1637
URL      : https://github.com/boto/botocore/archive/1.34.120/botocore-1.34.120.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.120/botocore-1.34.120.tar.gz
...
%prep
%setup -q -n botocore-1.34.120
cd %{_builddir}/botocore-1.34.120
pushd ..
cp -a botocore-1.34.120 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717617512
