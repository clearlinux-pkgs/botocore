...
Version  : 1.29.129
Release  : 1367
URL      : https://github.com/boto/botocore/archive/1.29.129/botocore-1.29.129.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.129/botocore-1.29.129.tar.gz
...
%prep
%setup -q -n botocore-1.29.129
cd %{_builddir}/botocore-1.29.129
pushd ..
cp -a botocore-1.29.129 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683327540
