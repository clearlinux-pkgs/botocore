...
Version  : 1.34.136
Release  : 1653
URL      : https://github.com/boto/botocore/archive/1.34.136/botocore-1.34.136.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.136/botocore-1.34.136.tar.gz
...
%prep
%setup -q -n botocore-1.34.136
cd %{_builddir}/botocore-1.34.136
pushd ..
cp -a botocore-1.34.136 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719852781
