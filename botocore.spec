...
Version  : 1.36.14
Release  : 1790
URL      : https://github.com/boto/botocore/archive/1.36.14/botocore-1.36.14.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.36.14/botocore-1.36.14.tar.gz
...
%prep
%setup -q -n botocore-1.36.14
cd %{_builddir}/botocore-1.36.14
pushd ..
cp -a botocore-1.36.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738788469
