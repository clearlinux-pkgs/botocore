...
Version  : 1.35.98
Release  : 1774
URL      : https://github.com/boto/botocore/archive/1.35.98/botocore-1.35.98.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.98/botocore-1.35.98.tar.gz
...
%prep
%setup -q -n botocore-1.35.98
cd %{_builddir}/botocore-1.35.98
pushd ..
cp -a botocore-1.35.98 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736801670
