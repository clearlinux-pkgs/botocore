...
Source0  : https://github.com/boto/botocore/archive/1.34.2/botocore-1.34.2.tar.gz
...
%prep
%setup -q -n botocore-1.34.2
cd %{_builddir}/botocore-1.34.2
pushd ..
cp -a botocore-1.34.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702683974
