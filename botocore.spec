...
Version  : 1.34.96
Release  : 1613
URL      : https://github.com/boto/botocore/archive/1.34.96/botocore-1.34.96.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.96/botocore-1.34.96.tar.gz
...
%prep
%setup -q -n botocore-1.34.96
cd %{_builddir}/botocore-1.34.96
pushd ..
cp -a botocore-1.34.96 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714593999
