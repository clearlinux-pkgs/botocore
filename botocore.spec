...
Version  : 1.34.122
Release  : 1639
URL      : https://github.com/boto/botocore/archive/1.34.122/botocore-1.34.122.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.122/botocore-1.34.122.tar.gz
...
%prep
%setup -q -n botocore-1.34.122
cd %{_builddir}/botocore-1.34.122
pushd ..
cp -a botocore-1.34.122 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717790458
