...
Version  : 1.35.65
Release  : 1749
URL      : https://github.com/boto/botocore/archive/1.35.65/botocore-1.35.65.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.65/botocore-1.35.65.tar.gz
...
%prep
%setup -q -n botocore-1.35.65
cd %{_builddir}/botocore-1.35.65
pushd ..
cp -a botocore-1.35.65 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732061311
