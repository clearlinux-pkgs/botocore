...
Version  : 1.35.30
Release  : 1714
URL      : https://github.com/boto/botocore/archive/1.35.30/botocore-1.35.30.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.30/botocore-1.35.30.tar.gz
...
%prep
%setup -q -n botocore-1.35.30
cd %{_builddir}/botocore-1.35.30
pushd ..
cp -a botocore-1.35.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727758217
