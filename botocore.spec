...
Version  : 1.35.55
Release  : 1739
URL      : https://github.com/boto/botocore/archive/1.35.55/botocore-1.35.55.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.55/botocore-1.35.55.tar.gz
...
%prep
%setup -q -n botocore-1.35.55
cd %{_builddir}/botocore-1.35.55
pushd ..
cp -a botocore-1.35.55 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730926227
