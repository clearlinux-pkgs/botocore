...
Version  : 1.36.15
Release  : 1791
URL      : https://github.com/boto/botocore/archive/1.36.15/botocore-1.36.15.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.36.15/botocore-1.36.15.tar.gz
...
%prep
%setup -q -n botocore-1.36.15
cd %{_builddir}/botocore-1.36.15
pushd ..
cp -a botocore-1.36.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738875789
