...
Source0  : https://github.com/boto/botocore/archive/1.31.81/botocore-1.31.81.tar.gz
...
%prep
%setup -q -n botocore-1.31.81
cd %{_builddir}/botocore-1.31.81
pushd ..
cp -a botocore-1.31.81 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699487341
