...
Version  : 1.20.50
Release  : 853
URL      : https://github.com/boto/botocore/archive/1.20.50/botocore-1.20.50.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.20.50/botocore-1.20.50.tar.gz
...
%prep
%setup -q -n botocore-1.20.50
cd %{_builddir}/botocore-1.20.50
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618324634
...
cp %{_builddir}/botocore-1.20.50/LICENSE.txt %{buildroot}/usr/share/package-licenses/botocore/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/botocore-1.20.50/NOTICE %{buildroot}/usr/share/package-licenses/botocore/d7a178c24429fa0e1bb6f6375b0db31677f1ac19
