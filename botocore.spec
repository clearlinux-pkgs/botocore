...
Version  : 1.34.34
Release  : 1551
URL      : https://github.com/boto/botocore/archive/1.34.34/botocore-1.34.34.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.34/botocore-1.34.34.tar.gz
...
%prep
%setup -q -n botocore-1.34.34
cd %{_builddir}/botocore-1.34.34
pushd ..
cp -a botocore-1.34.34 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706906977
