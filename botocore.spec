...
Version  : 1.34.65
Release  : 1582
URL      : https://github.com/boto/botocore/archive/1.34.65/botocore-1.34.65.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.65/botocore-1.34.65.tar.gz
...
%prep
%setup -q -n botocore-1.34.65
cd %{_builddir}/botocore-1.34.65
pushd ..
cp -a botocore-1.34.65 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710802266
