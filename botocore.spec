...
Source0  : https://github.com/boto/botocore/archive/1.35.19/botocore-1.35.19.tar.gz
...
%prep
%setup -q -n botocore-1.35.19
cd %{_builddir}/botocore-1.35.19
pushd ..
cp -a botocore-1.35.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726256999
