...
Version  : 1.29.64
Release  : 1301
URL      : https://github.com/boto/botocore/archive/1.29.64/botocore-1.29.64.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.64/botocore-1.29.64.tar.gz
...
%prep
%setup -q -n botocore-1.29.64
cd %{_builddir}/botocore-1.29.64
pushd ..
cp -a botocore-1.29.64 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675467940
