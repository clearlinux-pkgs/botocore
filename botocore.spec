...
Version  : 1.38.28
Release  : 1868
URL      : https://github.com/boto/botocore/archive/1.38.28/botocore-1.38.28.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.28/botocore-1.38.28.tar.gz
...
%prep
%setup -q -n botocore-1.38.28
cd %{_builddir}/botocore-1.38.28
pushd ..
cp -a botocore-1.38.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748894660
