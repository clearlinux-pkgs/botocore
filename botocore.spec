...
Version  : 1.34.83
Release  : 1600
URL      : https://github.com/boto/botocore/archive/1.34.83/botocore-1.34.83.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.83/botocore-1.34.83.tar.gz
...
%prep
%setup -q -n botocore-1.34.83
cd %{_builddir}/botocore-1.34.83
pushd ..
cp -a botocore-1.34.83 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712866100
