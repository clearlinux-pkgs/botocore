...
Source0  : https://github.com/boto/botocore/archive/1.13.44/botocore-1.13.44.tar.gz
...
%prep
%setup -q -n botocore-1.13.44
cd %{_builddir}/botocore-1.13.44
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1577136442
...
cp %{_builddir}/botocore-1.13.44/LICENSE.txt %{buildroot}/usr/share/package-licenses/botocore/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/botocore-1.13.44/NOTICE %{buildroot}/usr/share/package-licenses/botocore/d7a178c24429fa0e1bb6f6375b0db31677f1ac19
