...
Source0  : https://github.com/boto/botocore/archive/1.37.11/botocore-1.37.11.tar.gz
...
%prep
%setup -q -n botocore-1.37.11
cd %{_builddir}/botocore-1.37.11
pushd ..
cp -a botocore-1.37.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741741729
