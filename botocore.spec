...
Version  : 1.29.70
Release  : 1307
URL      : https://github.com/boto/botocore/archive/1.29.70/botocore-1.29.70.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.70/botocore-1.29.70.tar.gz
...
%prep
%setup -q -n botocore-1.29.70
cd %{_builddir}/botocore-1.29.70
pushd ..
cp -a botocore-1.29.70 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676320987
