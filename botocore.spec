...
Version  : 1.29.144
Release  : 1382
URL      : https://github.com/boto/botocore/archive/1.29.144/botocore-1.29.144.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.144/botocore-1.29.144.tar.gz
...
%prep
%setup -q -n botocore-1.29.144
cd %{_builddir}/botocore-1.29.144
pushd ..
cp -a botocore-1.29.144 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685563393
