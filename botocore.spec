...
Version  : 1.38.7
Release  : 1847
URL      : https://github.com/boto/botocore/archive/1.38.7/botocore-1.38.7.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.7/botocore-1.38.7.tar.gz
...
%prep
%setup -q -n botocore-1.38.7
cd %{_builddir}/botocore-1.38.7
pushd ..
cp -a botocore-1.38.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746128803
