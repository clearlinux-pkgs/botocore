...
Version  : 1.29.111
Release  : 1349
URL      : https://github.com/boto/botocore/archive/1.29.111/botocore-1.29.111.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.111/botocore-1.29.111.tar.gz
...
%prep
%setup -q -n botocore-1.29.111
cd %{_builddir}/botocore-1.29.111
pushd ..
cp -a botocore-1.29.111 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681253254
