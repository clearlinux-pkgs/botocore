...
Version  : 1.34.129
Release  : 1646
URL      : https://github.com/boto/botocore/archive/1.34.129/botocore-1.34.129.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.129/botocore-1.34.129.tar.gz
...
%prep
%setup -q -n botocore-1.34.129
cd %{_builddir}/botocore-1.34.129
pushd ..
cp -a botocore-1.34.129 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718740859
