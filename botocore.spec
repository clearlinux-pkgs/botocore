...
Version  : 1.29.138
Release  : 1376
URL      : https://github.com/boto/botocore/archive/1.29.138/botocore-1.29.138.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.138/botocore-1.29.138.tar.gz
...
%prep
%setup -q -n botocore-1.29.138
cd %{_builddir}/botocore-1.29.138
pushd ..
cp -a botocore-1.29.138 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684784763
