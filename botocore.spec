...
Version  : 1.29.37
Release  : 1274
URL      : https://github.com/boto/botocore/archive/1.29.37/botocore-1.29.37.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.37/botocore-1.29.37.tar.gz
...
%prep
%setup -q -n botocore-1.29.37
cd %{_builddir}/botocore-1.29.37
pushd ..
cp -a botocore-1.29.37 buildavx2
cp -a botocore-1.29.37 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671828646
