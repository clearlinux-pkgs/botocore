...
Source0  : https://github.com/boto/botocore/archive/1.35.60/botocore-1.35.60.tar.gz
...
%prep
%setup -q -n botocore-1.35.60
cd %{_builddir}/botocore-1.35.60
pushd ..
cp -a botocore-1.35.60 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731530902
