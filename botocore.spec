...
Version  : 1.34.135
Release  : 1652
URL      : https://github.com/boto/botocore/archive/1.34.135/botocore-1.34.135.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.135/botocore-1.34.135.tar.gz
...
%prep
%setup -q -n botocore-1.34.135
cd %{_builddir}/botocore-1.34.135
pushd ..
cp -a botocore-1.34.135 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719517701
