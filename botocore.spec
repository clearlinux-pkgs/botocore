...
Source0  : https://github.com/boto/botocore/archive/1.33.1/botocore-1.33.1.tar.gz
...
%prep
%setup -q -n botocore-1.33.1
cd %{_builddir}/botocore-1.33.1
pushd ..
cp -a botocore-1.33.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701161290
