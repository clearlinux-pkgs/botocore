...
Version  : 1.27.47
Release  : 1175
URL      : https://github.com/boto/botocore/archive/1.27.47/botocore-1.27.47.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.47/botocore-1.27.47.tar.gz
...
%prep
%setup -q -n botocore-1.27.47
cd %{_builddir}/botocore-1.27.47
pushd ..
cp -a botocore-1.27.47 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659988287
