...
Source0  : https://github.com/boto/botocore/archive/1.34.45/botocore-1.34.45.tar.gz
...
%prep
%setup -q -n botocore-1.34.45
cd %{_builddir}/botocore-1.34.45
pushd ..
cp -a botocore-1.34.45 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708375975
