...
Version  : 1.35.31
Release  : 1715
URL      : https://github.com/boto/botocore/archive/1.35.31/botocore-1.35.31.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.31/botocore-1.35.31.tar.gz
...
%prep
%setup -q -n botocore-1.35.31
cd %{_builddir}/botocore-1.35.31
pushd ..
cp -a botocore-1.35.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727812736
