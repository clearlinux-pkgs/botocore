...
Version  : 1.35.40
Release  : 1723
URL      : https://github.com/boto/botocore/archive/1.35.40/botocore-1.35.40.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.40/botocore-1.35.40.tar.gz
...
%prep
%setup -q -n botocore-1.35.40
cd %{_builddir}/botocore-1.35.40
pushd ..
cp -a botocore-1.35.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728936371
