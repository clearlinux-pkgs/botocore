...
Version  : 1.35.7
Release  : 1689
URL      : https://github.com/boto/botocore/archive/1.35.7/botocore-1.35.7.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.7/botocore-1.35.7.tar.gz
...
%prep
%setup -q -n botocore-1.35.7
cd %{_builddir}/botocore-1.35.7
pushd ..
cp -a botocore-1.35.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724788314
