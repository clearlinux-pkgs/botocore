...
Source0  : https://github.com/boto/botocore/archive/1.28.4/botocore-1.28.4.tar.gz
...
%prep
%setup -q -n botocore-1.28.4
cd %{_builddir}/botocore-1.28.4
pushd ..
cp -a botocore-1.28.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666986094
