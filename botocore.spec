...
Source0  : https://github.com/boto/botocore/archive/1.35.62/botocore-1.35.62.tar.gz
...
%prep
%setup -q -n botocore-1.35.62
cd %{_builddir}/botocore-1.35.62
pushd ..
cp -a botocore-1.35.62 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731649812
