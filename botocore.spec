...
Version  : 1.34.57
Release  : 1574
URL      : https://github.com/boto/botocore/archive/1.34.57/botocore-1.34.57.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.57/botocore-1.34.57.tar.gz
...
%prep
%setup -q -n botocore-1.34.57
cd %{_builddir}/botocore-1.34.57
pushd ..
cp -a botocore-1.34.57 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709769058
