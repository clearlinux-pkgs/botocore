...
Version  : 1.29.125
Release  : 1363
URL      : https://github.com/boto/botocore/archive/1.29.125/botocore-1.29.125.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.125/botocore-1.29.125.tar.gz
...
%prep
%setup -q -n botocore-1.29.125
cd %{_builddir}/botocore-1.29.125
pushd ..
cp -a botocore-1.29.125 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683068496
