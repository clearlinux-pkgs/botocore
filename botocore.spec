...
Version  : 1.35.74
Release  : 1758
URL      : https://github.com/boto/botocore/archive/1.35.74/botocore-1.35.74.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.74/botocore-1.35.74.tar.gz
...
%prep
%setup -q -n botocore-1.35.74
cd %{_builddir}/botocore-1.35.74
pushd ..
cp -a botocore-1.35.74 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733259676
