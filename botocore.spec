...
Version  : 1.34.121
Release  : 1638
URL      : https://github.com/boto/botocore/archive/1.34.121/botocore-1.34.121.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.121/botocore-1.34.121.tar.gz
...
%prep
%setup -q -n botocore-1.34.121
cd %{_builddir}/botocore-1.34.121
pushd ..
cp -a botocore-1.34.121 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717703782
