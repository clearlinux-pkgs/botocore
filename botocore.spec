...
Version  : 1.29.49
Release  : 1286
URL      : https://github.com/boto/botocore/archive/1.29.49/botocore-1.29.49.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.49/botocore-1.29.49.tar.gz
...
%prep
%setup -q -n botocore-1.29.49
cd %{_builddir}/botocore-1.29.49
pushd ..
cp -a botocore-1.29.49 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673556398
