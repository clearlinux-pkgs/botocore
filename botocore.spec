...
Version  : 1.34.85
Release  : 1602
URL      : https://github.com/boto/botocore/archive/1.34.85/botocore-1.34.85.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.85/botocore-1.34.85.tar.gz
...
%prep
%setup -q -n botocore-1.34.85
cd %{_builddir}/botocore-1.34.85
pushd ..
cp -a botocore-1.34.85 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713297725
