...
Version  : 1.39.2
Release  : 1888
URL      : https://github.com/boto/botocore/archive/1.39.2/botocore-1.39.2.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.39.2/botocore-1.39.2.tar.gz
...
%prep
%setup -q -n botocore-1.39.2
cd %{_builddir}/botocore-1.39.2
pushd ..
cp -a botocore-1.39.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751494314
