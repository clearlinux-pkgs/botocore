...
Version  : 1.34.38
Release  : 1555
URL      : https://github.com/boto/botocore/archive/1.34.38/botocore-1.34.38.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.38/botocore-1.34.38.tar.gz
...
%prep
%setup -q -n botocore-1.34.38
cd %{_builddir}/botocore-1.34.38
pushd ..
cp -a botocore-1.34.38 buildavx2
popd
pushd ..
cp -a botocore-1.34.38 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707425822
