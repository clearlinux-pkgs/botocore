...
Version  : 1.29.113
Release  : 1351
URL      : https://github.com/boto/botocore/archive/1.29.113/botocore-1.29.113.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.113/botocore-1.29.113.tar.gz
...
%prep
%setup -q -n botocore-1.29.113
cd %{_builddir}/botocore-1.29.113
pushd ..
cp -a botocore-1.29.113 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681416058
