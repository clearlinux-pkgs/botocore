...
Version  : 1.34.63
Release  : 1580
URL      : https://github.com/boto/botocore/archive/1.34.63/botocore-1.34.63.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.63/botocore-1.34.63.tar.gz
...
%prep
%setup -q -n botocore-1.34.63
cd %{_builddir}/botocore-1.34.63
pushd ..
cp -a botocore-1.34.63 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710446324
