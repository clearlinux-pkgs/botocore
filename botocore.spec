...
Version  : 1.35.94
Release  : 1770
URL      : https://github.com/boto/botocore/archive/1.35.94/botocore-1.35.94.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.94/botocore-1.35.94.tar.gz
...
%prep
%setup -q -n botocore-1.35.94
cd %{_builddir}/botocore-1.35.94
pushd ..
cp -a botocore-1.35.94 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736283750
