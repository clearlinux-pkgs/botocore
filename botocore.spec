...
Version  : 1.31.60
Release  : 1469
URL      : https://github.com/boto/botocore/archive/1.31.60/botocore-1.31.60.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.60/botocore-1.31.60.tar.gz
...
%prep
%setup -q -n botocore-1.31.60
cd %{_builddir}/botocore-1.31.60
pushd ..
cp -a botocore-1.31.60 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696459626
