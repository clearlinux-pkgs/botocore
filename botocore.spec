...
Version  : 1.29.147
Release  : 1385
URL      : https://github.com/boto/botocore/archive/1.29.147/botocore-1.29.147.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.147/botocore-1.29.147.tar.gz
...
%prep
%setup -q -n botocore-1.29.147
cd %{_builddir}/botocore-1.29.147
pushd ..
cp -a botocore-1.29.147 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685995594
