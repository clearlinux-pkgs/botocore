...
Version  : 1.29.105
Release  : 1343
URL      : https://github.com/boto/botocore/archive/1.29.105/botocore-1.29.105.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.105/botocore-1.29.105.tar.gz
...
%prep
%setup -q -n botocore-1.29.105
cd %{_builddir}/botocore-1.29.105
pushd ..
cp -a botocore-1.29.105 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680551590
