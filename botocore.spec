...
Version  : 1.35.24
Release  : 1706
URL      : https://github.com/boto/botocore/archive/1.35.24/botocore-1.35.24.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.24/botocore-1.35.24.tar.gz
...
%prep
%setup -q -n botocore-1.35.24
cd %{_builddir}/botocore-1.35.24
pushd ..
cp -a botocore-1.35.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726861623
