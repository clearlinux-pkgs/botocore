...
Version  : 1.29.81
Release  : 1318
URL      : https://github.com/boto/botocore/archive/1.29.81/botocore-1.29.81.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.81/botocore-1.29.81.tar.gz
...
%prep
%setup -q -n botocore-1.29.81
cd %{_builddir}/botocore-1.29.81
pushd ..
cp -a botocore-1.29.81 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677617091
