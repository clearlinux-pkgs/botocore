...
Version  : 1.34.149
Release  : 1666
URL      : https://github.com/boto/botocore/archive/1.34.149/botocore-1.34.149.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.149/botocore-1.34.149.tar.gz
...
%prep
%setup -q -n botocore-1.34.149
cd %{_builddir}/botocore-1.34.149
pushd ..
cp -a botocore-1.34.149 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721947515
