...
Version  : 1.29.93
Release  : 1331
URL      : https://github.com/boto/botocore/archive/1.29.93/botocore-1.29.93.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.93/botocore-1.29.93.tar.gz
...
%prep
%setup -q -n botocore-1.29.93
cd %{_builddir}/botocore-1.29.93
pushd ..
cp -a botocore-1.29.93 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678996261
