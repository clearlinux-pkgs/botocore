...
Version  : 1.35.33
Release  : 1717
URL      : https://github.com/boto/botocore/archive/1.35.33/botocore-1.35.33.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.33/botocore-1.35.33.tar.gz
...
%prep
%setup -q -n botocore-1.35.33
cd %{_builddir}/botocore-1.35.33
pushd ..
cp -a botocore-1.35.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727984725
