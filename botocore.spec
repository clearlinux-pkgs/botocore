...
Version  : 1.34.132
Release  : 1649
URL      : https://github.com/boto/botocore/archive/1.34.132/botocore-1.34.132.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.132/botocore-1.34.132.tar.gz
...
%prep
%setup -q -n botocore-1.34.132
cd %{_builddir}/botocore-1.34.132
pushd ..
cp -a botocore-1.34.132 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719269652
