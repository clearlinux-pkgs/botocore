...
Version  : 1.34.145
Release  : 1662
URL      : https://github.com/boto/botocore/archive/1.34.145/botocore-1.34.145.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.145/botocore-1.34.145.tar.gz
...
%prep
%setup -q -n botocore-1.34.145
cd %{_builddir}/botocore-1.34.145
pushd ..
cp -a botocore-1.34.145 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721342878
