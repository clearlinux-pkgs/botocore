...
Source0  : https://github.com/boto/botocore/archive/1.29.92/botocore-1.29.92.tar.gz
...
%prep
%setup -q -n botocore-1.29.92
cd %{_builddir}/botocore-1.29.92
pushd ..
cp -a botocore-1.29.92 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678909840
