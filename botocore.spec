...
Version  : 1.27.81
Release  : 1213
URL      : https://github.com/boto/botocore/archive/1.27.81/botocore-1.27.81.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.81/botocore-1.27.81.tar.gz
...
%prep
%setup -q -n botocore-1.27.81
cd %{_builddir}/botocore-1.27.81
pushd ..
cp -a botocore-1.27.81 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664221595
