...
Version  : 1.34.78
Release  : 1595
URL      : https://github.com/boto/botocore/archive/1.34.78/botocore-1.34.78.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.78/botocore-1.34.78.tar.gz
...
%prep
%setup -q -n botocore-1.34.78
cd %{_builddir}/botocore-1.34.78
pushd ..
cp -a botocore-1.34.78 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712260943
