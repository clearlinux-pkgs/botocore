...
Version  : 1.27.76
Release  : 1208
URL      : https://github.com/boto/botocore/archive/1.27.76/botocore-1.27.76.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.76/botocore-1.27.76.tar.gz
...
%prep
%setup -q -n botocore-1.27.76
cd %{_builddir}/botocore-1.27.76
pushd ..
cp -a botocore-1.27.76 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663617132
