...
Version  : 1.34.46
Release  : 1563
URL      : https://github.com/boto/botocore/archive/1.34.46/botocore-1.34.46.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.46/botocore-1.34.46.tar.gz
...
%prep
%setup -q -n botocore-1.34.46
cd %{_builddir}/botocore-1.34.46
pushd ..
cp -a botocore-1.34.46 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708462330
