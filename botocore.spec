...
Version  : 1.37.20
Release  : 1820
URL      : https://github.com/boto/botocore/archive/1.37.20/botocore-1.37.20.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.37.20/botocore-1.37.20.tar.gz
...
%prep
%setup -q -n botocore-1.37.20
cd %{_builddir}/botocore-1.37.20
pushd ..
cp -a botocore-1.37.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742932952
