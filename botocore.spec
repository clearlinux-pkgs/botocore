...
Source0  : https://github.com/boto/botocore/archive/1.35.51/botocore-1.35.51.tar.gz
...
%prep
%setup -q -n botocore-1.35.51
cd %{_builddir}/botocore-1.35.51
pushd ..
cp -a botocore-1.35.51 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730248029
