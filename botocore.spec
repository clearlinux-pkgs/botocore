...
Version  : 1.34.144
Release  : 1661
URL      : https://github.com/boto/botocore/archive/1.34.144/botocore-1.34.144.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.144/botocore-1.34.144.tar.gz
...
%prep
%setup -q -n botocore-1.34.144
cd %{_builddir}/botocore-1.34.144
pushd ..
cp -a botocore-1.34.144 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720814972
