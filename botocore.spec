...
Version  : 1.31.49
Release  : 1455
URL      : https://github.com/boto/botocore/archive/1.31.49/botocore-1.31.49.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.49/botocore-1.31.49.tar.gz
...
%prep
%setup -q -n botocore-1.31.49
cd %{_builddir}/botocore-1.31.49
pushd ..
cp -a botocore-1.31.49 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694818072
