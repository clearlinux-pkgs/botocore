...
Version  : 1.27.66
Release  : 1198
URL      : https://github.com/boto/botocore/archive/1.27.66/botocore-1.27.66.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.66/botocore-1.27.66.tar.gz
...
%prep
%setup -q -n botocore-1.27.66
cd %{_builddir}/botocore-1.27.66
pushd ..
cp -a botocore-1.27.66 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662148028
