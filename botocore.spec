...
Version  : 1.31.48
Release  : 1454
URL      : https://github.com/boto/botocore/archive/1.31.48/botocore-1.31.48.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.48/botocore-1.31.48.tar.gz
...
%prep
%setup -q -n botocore-1.31.48
cd %{_builddir}/botocore-1.31.48
pushd ..
cp -a botocore-1.31.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694731510
