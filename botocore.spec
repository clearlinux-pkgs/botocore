...
Version  : 1.31.45
Release  : 1451
URL      : https://github.com/boto/botocore/archive/1.31.45/botocore-1.31.45.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.45/botocore-1.31.45.tar.gz
...
%prep
%setup -q -n botocore-1.31.45
cd %{_builddir}/botocore-1.31.45
pushd ..
cp -a botocore-1.31.45 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694462219
