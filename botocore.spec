...
Version  : 1.34.90
Release  : 1607
URL      : https://github.com/boto/botocore/archive/1.34.90/botocore-1.34.90.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.90/botocore-1.34.90.tar.gz
...
%prep
%setup -q -n botocore-1.34.90
cd %{_builddir}/botocore-1.34.90
pushd ..
cp -a botocore-1.34.90 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713902687
