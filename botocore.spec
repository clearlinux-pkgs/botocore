...
Source0  : https://github.com/boto/botocore/archive/1.35.67/botocore-1.35.67.tar.gz
...
%prep
%setup -q -n botocore-1.35.67
cd %{_builddir}/botocore-1.35.67
pushd ..
cp -a botocore-1.35.67 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732243856
