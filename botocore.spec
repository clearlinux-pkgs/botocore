...
Source0  : https://github.com/boto/botocore/archive/1.27.42/botocore-1.27.42.tar.gz
...
%prep
%setup -q -n botocore-1.27.42
cd %{_builddir}/botocore-1.27.42
pushd ..
cp -a botocore-1.27.42 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659221453
