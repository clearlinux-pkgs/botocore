...
Version  : 1.29.101
Release  : 1339
URL      : https://github.com/boto/botocore/archive/1.29.101/botocore-1.29.101.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.101/botocore-1.29.101.tar.gz
...
%prep
%setup -q -n botocore-1.29.101
cd %{_builddir}/botocore-1.29.101
pushd ..
cp -a botocore-1.29.101 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680044369
