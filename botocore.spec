...
Source0  : https://github.com/boto/botocore/archive/1.37.27/botocore-1.37.27.tar.gz
...
%prep
%setup -q -n botocore-1.37.27
cd %{_builddir}/botocore-1.37.27
pushd ..
cp -a botocore-1.37.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743710120
