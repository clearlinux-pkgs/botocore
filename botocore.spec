...
Source0  : https://github.com/boto/botocore/archive/1.34.159/botocore-1.34.159.tar.gz
...
%prep
%setup -q -n botocore-1.34.159
cd %{_builddir}/botocore-1.34.159
pushd ..
cp -a botocore-1.34.159 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723492086
