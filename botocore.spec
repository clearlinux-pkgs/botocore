...
Source0  : https://github.com/boto/botocore/archive/1.27.70/botocore-1.27.70.tar.gz
...
%prep
%setup -q -n botocore-1.27.70
cd %{_builddir}/botocore-1.27.70
pushd ..
cp -a botocore-1.27.70 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662752783
