...
Source0  : https://github.com/boto/botocore/archive/1.29.98/botocore-1.29.98.tar.gz
...
%prep
%setup -q -n botocore-1.29.98
cd %{_builddir}/botocore-1.29.98
pushd ..
cp -a botocore-1.29.98 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679668282
