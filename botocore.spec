...
Version  : 1.29.163
Release  : 1401
URL      : https://github.com/boto/botocore/archive/1.29.163/botocore-1.29.163.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.163/botocore-1.29.163.tar.gz
...
%prep
%setup -q -n botocore-1.29.163
cd %{_builddir}/botocore-1.29.163
pushd ..
cp -a botocore-1.29.163 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687981536
