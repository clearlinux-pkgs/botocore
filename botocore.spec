...
Version  : 1.35.84
Release  : 1762
URL      : https://github.com/boto/botocore/archive/1.35.84/botocore-1.35.84.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.84/botocore-1.35.84.tar.gz
...
%prep
%setup -q -n botocore-1.35.84
cd %{_builddir}/botocore-1.35.84
pushd ..
cp -a botocore-1.35.84 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1734590158
