...
Source0  : https://github.com/boto/botocore/archive/1.33.0/botocore-1.33.0.tar.gz
...
%prep
%setup -q -n botocore-1.33.0
cd %{_builddir}/botocore-1.33.0
pushd ..
cp -a botocore-1.33.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701129553
