...
Version  : 1.37.38
Release  : 1839
URL      : https://github.com/boto/botocore/archive/1.37.38/botocore-1.37.38.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.37.38/botocore-1.37.38.tar.gz
...
%prep
%setup -q -n botocore-1.37.38
cd %{_builddir}/botocore-1.37.38
pushd ..
cp -a botocore-1.37.38 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745271761
