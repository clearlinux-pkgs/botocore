...
Version  : 1.29.77
Release  : 1314
URL      : https://github.com/boto/botocore/archive/1.29.77/botocore-1.29.77.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.77/botocore-1.29.77.tar.gz
...
%prep
%setup -q -n botocore-1.29.77
cd %{_builddir}/botocore-1.29.77
pushd ..
cp -a botocore-1.29.77 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677098352
