...
Source0  : https://github.com/boto/botocore/archive/1.34.110/botocore-1.34.110.tar.gz
...
%prep
%setup -q -n botocore-1.34.110
cd %{_builddir}/botocore-1.34.110
pushd ..
cp -a botocore-1.34.110 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716321090
