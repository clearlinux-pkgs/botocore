...
Source0  : https://github.com/boto/botocore/archive/1.34.118/botocore-1.34.118.tar.gz
...
%prep
%setup -q -n botocore-1.34.118
cd %{_builddir}/botocore-1.34.118
pushd ..
cp -a botocore-1.34.118 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717445036
