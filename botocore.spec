...
Version  : 1.27.44
Release  : 1173
URL      : https://github.com/boto/botocore/archive/1.27.44/botocore-1.27.44.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.44/botocore-1.27.44.tar.gz
...
%prep
%setup -q -n botocore-1.27.44
cd %{_builddir}/botocore-1.27.44
pushd ..
cp -a botocore-1.27.44 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659469453
