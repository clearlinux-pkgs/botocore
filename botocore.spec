...
Source0  : https://github.com/boto/botocore/archive/1.34.157/botocore-1.34.157.tar.gz
...
%prep
%setup -q -n botocore-1.34.157
cd %{_builddir}/botocore-1.34.157
pushd ..
cp -a botocore-1.34.157 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723149450
