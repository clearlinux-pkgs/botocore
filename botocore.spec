...
Version  : 1.27.92
Release  : 1224
URL      : https://github.com/boto/botocore/archive/1.27.92/botocore-1.27.92.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.92/botocore-1.27.92.tar.gz
...
%prep
%setup -q -n botocore-1.27.92
cd %{_builddir}/botocore-1.27.92
pushd ..
cp -a botocore-1.27.92 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666036057
