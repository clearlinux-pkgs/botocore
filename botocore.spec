...
Version  : 1.31.80
Release  : 1489
URL      : https://github.com/boto/botocore/archive/1.31.80/botocore-1.31.80.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.80/botocore-1.31.80.tar.gz
...
%prep
%setup -q -n botocore-1.31.80
cd %{_builddir}/botocore-1.31.80
pushd ..
cp -a botocore-1.31.80 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699400807
