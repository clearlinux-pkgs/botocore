...
Version  : 1.29.106
Release  : 1344
URL      : https://github.com/boto/botocore/archive/1.29.106/botocore-1.29.106.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.106/botocore-1.29.106.tar.gz
...
%prep
%setup -q -n botocore-1.29.106
cd %{_builddir}/botocore-1.29.106
pushd ..
cp -a botocore-1.29.106 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680637655
