...
Source0  : https://github.com/boto/botocore/archive/1.31.43/botocore-1.31.43.tar.gz
...
%prep
%setup -q -n botocore-1.31.43
cd %{_builddir}/botocore-1.31.43
pushd ..
cp -a botocore-1.31.43 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694126796
