...
Version  : 1.34.123
Release  : 1640
URL      : https://github.com/boto/botocore/archive/1.34.123/botocore-1.34.123.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.123/botocore-1.34.123.tar.gz
...
%prep
%setup -q -n botocore-1.34.123
cd %{_builddir}/botocore-1.34.123
pushd ..
cp -a botocore-1.34.123 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718050443
