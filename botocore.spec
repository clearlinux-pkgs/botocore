...
Version  : 1.21.32
Release  : 945
URL      : https://github.com/boto/botocore/archive/1.21.32/botocore-1.21.32.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.21.32/botocore-1.21.32.tar.gz
...
%prep
%setup -q -n botocore-1.21.32
cd %{_builddir}/botocore-1.21.32
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630363812
...
cp %{_builddir}/botocore-1.21.32/LICENSE.txt %{buildroot}/usr/share/package-licenses/botocore/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/botocore-1.21.32/NOTICE %{buildroot}/usr/share/package-licenses/botocore/d7a178c24429fa0e1bb6f6375b0db31677f1ac19
cp %{_builddir}/botocore-1.21.32/tests/unit/auth/aws4_testsuite/LICENSE %{buildroot}/usr/share/package-licenses/botocore/2b8b815229aa8a61e483fb4ba0588b8b6c491890
