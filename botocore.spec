...
Version  : 1.27.68
Release  : 1200
URL      : https://github.com/boto/botocore/archive/1.27.68/botocore-1.27.68.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.68/botocore-1.27.68.tar.gz
...
%prep
%setup -q -n botocore-1.27.68
cd %{_builddir}/botocore-1.27.68
pushd ..
cp -a botocore-1.27.68 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662591357
