...
Version  : 1.35.64
Release  : 1748
URL      : https://github.com/boto/botocore/archive/1.35.64/botocore-1.35.64.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.64/botocore-1.35.64.tar.gz
...
%prep
%setup -q -n botocore-1.35.64
cd %{_builddir}/botocore-1.35.64
pushd ..
cp -a botocore-1.35.64 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731963786
