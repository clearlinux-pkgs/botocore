...
Version  : 1.27.56
Release  : 1186
URL      : https://github.com/boto/botocore/archive/1.27.56/botocore-1.27.56.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.56/botocore-1.27.56.tar.gz
...
%prep
%setup -q -n botocore-1.27.56
cd %{_builddir}/botocore-1.27.56
pushd ..
cp -a botocore-1.27.56 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661189299
