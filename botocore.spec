...
Version  : 1.29.62
Release  : 1299
URL      : https://github.com/boto/botocore/archive/1.29.62/botocore-1.29.62.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.62/botocore-1.29.62.tar.gz
...
%prep
%setup -q -n botocore-1.29.62
cd %{_builddir}/botocore-1.29.62
pushd ..
cp -a botocore-1.29.62 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675284008
