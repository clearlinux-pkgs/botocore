...
Source0  : https://github.com/boto/botocore/archive/1.38.8/botocore-1.38.8.tar.gz
...
%prep
%setup -q -n botocore-1.38.8
cd %{_builddir}/botocore-1.38.8
pushd ..
cp -a botocore-1.38.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746237044
