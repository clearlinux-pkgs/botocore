...
Version  : 1.34.161
Release  : 1678
URL      : https://github.com/boto/botocore/archive/1.34.161/botocore-1.34.161.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.161/botocore-1.34.161.tar.gz
...
%prep
%setup -q -n botocore-1.34.161
cd %{_builddir}/botocore-1.34.161
pushd ..
cp -a botocore-1.34.161 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723665091
