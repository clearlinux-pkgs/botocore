...
Version  : 1.27.59
Release  : 1191
URL      : https://github.com/boto/botocore/archive/1.27.59/botocore-1.27.59.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.59/botocore-1.27.59.tar.gz
...
%prep
%setup -q -n botocore-1.27.59
cd %{_builddir}/botocore-1.27.59
pushd ..
cp -a botocore-1.27.59 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661381236
