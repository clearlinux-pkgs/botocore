...
Version  : 1.38.22
Release  : 1862
URL      : https://github.com/boto/botocore/archive/1.38.22/botocore-1.38.22.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.38.22/botocore-1.38.22.tar.gz
...
%prep
%setup -q -n botocore-1.38.22
cd %{_builddir}/botocore-1.38.22
pushd ..
cp -a botocore-1.38.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747943459
