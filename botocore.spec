...
Source0  : https://github.com/boto/botocore/archive/1.36.10/botocore-1.36.10.tar.gz
...
%prep
%setup -q -n botocore-1.36.10
cd %{_builddir}/botocore-1.36.10
pushd ..
cp -a botocore-1.36.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738335614
