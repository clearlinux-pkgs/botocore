...
Version  : 1.31.69
Release  : 1478
URL      : https://github.com/boto/botocore/archive/1.31.69/botocore-1.31.69.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.69/botocore-1.31.69.tar.gz
...
%prep
%setup -q -n botocore-1.31.69
cd %{_builddir}/botocore-1.31.69
pushd ..
cp -a botocore-1.31.69 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698101894
