...
Version  : 1.29.71
Release  : 1308
URL      : https://github.com/boto/botocore/archive/1.29.71/botocore-1.29.71.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.71/botocore-1.29.71.tar.gz
...
%prep
%setup -q -n botocore-1.29.71
cd %{_builddir}/botocore-1.29.71
pushd ..
cp -a botocore-1.29.71 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676407827
