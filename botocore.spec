...
Version  : 1.34.19
Release  : 1536
URL      : https://github.com/boto/botocore/archive/1.34.19/botocore-1.34.19.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.19/botocore-1.34.19.tar.gz
...
%prep
%setup -q -n botocore-1.34.19
cd %{_builddir}/botocore-1.34.19
pushd ..
cp -a botocore-1.34.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705222149
