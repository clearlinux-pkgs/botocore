...
Version  : 1.34.15
Release  : 1532
URL      : https://github.com/boto/botocore/archive/1.34.15/botocore-1.34.15.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.15/botocore-1.34.15.tar.gz
...
%prep
%setup -q -n botocore-1.34.15
cd %{_builddir}/botocore-1.34.15
pushd ..
cp -a botocore-1.34.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704757811
