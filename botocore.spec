...
Version  : 1.34.97
Release  : 1614
URL      : https://github.com/boto/botocore/archive/1.34.97/botocore-1.34.97.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.97/botocore-1.34.97.tar.gz
...
%prep
%setup -q -n botocore-1.34.97
cd %{_builddir}/botocore-1.34.97
pushd ..
cp -a botocore-1.34.97 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714680841
