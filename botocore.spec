...
Version  : 1.34.115
Release  : 1632
URL      : https://github.com/boto/botocore/archive/1.34.115/botocore-1.34.115.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.115/botocore-1.34.115.tar.gz
...
%prep
%setup -q -n botocore-1.34.115
cd %{_builddir}/botocore-1.34.115
pushd ..
cp -a botocore-1.34.115 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717012131
