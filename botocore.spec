...
Version  : 1.27.91
Release  : 1223
URL      : https://github.com/boto/botocore/archive/1.27.91/botocore-1.27.91.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.91/botocore-1.27.91.tar.gz
...
%prep
%setup -q -n botocore-1.27.91
cd %{_builddir}/botocore-1.27.91
pushd ..
cp -a botocore-1.27.91 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665777295
