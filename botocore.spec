...
Version  : 1.27.29
Release  : 1158
URL      : https://github.com/boto/botocore/archive/1.27.29/botocore-1.27.29.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.29/botocore-1.27.29.tar.gz
...
%prep
%setup -q -n botocore-1.27.29
cd %{_builddir}/botocore-1.27.29
pushd ..
cp -a botocore-1.27.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657752001
...
cp %{_builddir}/botocore-1.27.29/LICENSE.txt %{buildroot}/usr/share/package-licenses/botocore/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/botocore-1.27.29/NOTICE %{buildroot}/usr/share/package-licenses/botocore/0d0df7fdaeb87fbf13f0e3fd8533d87ab5e2bc21
cp %{_builddir}/botocore-1.27.29/tests/unit/auth/aws4_testsuite/LICENSE %{buildroot}/usr/share/package-licenses/botocore/2b8b815229aa8a61e483fb4ba0588b8b6c491890
