...
Version  : 1.31.16
Release  : 1422
URL      : https://github.com/boto/botocore/archive/1.31.16/botocore-1.31.16.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.16/botocore-1.31.16.tar.gz
...
%prep
%setup -q -n botocore-1.31.16
cd %{_builddir}/botocore-1.31.16
pushd ..
cp -a botocore-1.31.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690833015
