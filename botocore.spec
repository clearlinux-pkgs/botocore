...
Version  : 1.35.37
Release  : 1720
URL      : https://github.com/boto/botocore/archive/1.35.37/botocore-1.35.37.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.37/botocore-1.35.37.tar.gz
...
%prep
%setup -q -n botocore-1.35.37
cd %{_builddir}/botocore-1.35.37
pushd ..
cp -a botocore-1.35.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728504377
