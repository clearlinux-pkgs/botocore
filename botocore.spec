...
Version  : 1.35.99
Release  : 1775
URL      : https://github.com/boto/botocore/archive/1.35.99/botocore-1.35.99.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.99/botocore-1.35.99.tar.gz
...
%prep
%setup -q -n botocore-1.35.99
cd %{_builddir}/botocore-1.35.99
pushd ..
cp -a botocore-1.35.99 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736887668
