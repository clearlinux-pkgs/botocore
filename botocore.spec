...
Source0  : https://github.com/boto/botocore/archive/1.29.65/botocore-1.29.65.tar.gz
...
%prep
%setup -q -n botocore-1.29.65
cd %{_builddir}/botocore-1.29.65
pushd ..
cp -a botocore-1.29.65 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675716750
