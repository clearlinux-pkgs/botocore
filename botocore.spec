...
Version  : 1.31.66
Release  : 1475
URL      : https://github.com/boto/botocore/archive/1.31.66/botocore-1.31.66.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.66/botocore-1.31.66.tar.gz
...
%prep
%setup -q -n botocore-1.31.66
cd %{_builddir}/botocore-1.31.66
pushd ..
cp -a botocore-1.31.66 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697658275
