...
Version  : 1.35.56
Release  : 1740
URL      : https://github.com/boto/botocore/archive/1.35.56/botocore-1.35.56.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.56/botocore-1.35.56.tar.gz
...
%prep
%setup -q -n botocore-1.35.56
cd %{_builddir}/botocore-1.35.56
pushd ..
cp -a botocore-1.35.56 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731012133
