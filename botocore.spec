...
Source0  : https://github.com/boto/botocore/archive/1.37.34/botocore-1.37.34.tar.gz
...
%prep
%setup -q -n botocore-1.37.34
cd %{_builddir}/botocore-1.37.34
pushd ..
cp -a botocore-1.37.34 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744661355
