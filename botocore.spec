...
Source0  : https://github.com/boto/botocore/archive/1.34.3/botocore-1.34.3.tar.gz
...
%prep
%setup -q -n botocore-1.34.3
cd %{_builddir}/botocore-1.34.3
pushd ..
cp -a botocore-1.34.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702944280
