...
Version  : 1.31.79
Release  : 1488
URL      : https://github.com/boto/botocore/archive/1.31.79/botocore-1.31.79.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.79/botocore-1.31.79.tar.gz
...
%prep
%setup -q -n botocore-1.31.79
cd %{_builddir}/botocore-1.31.79
pushd ..
cp -a botocore-1.31.79 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699314493
