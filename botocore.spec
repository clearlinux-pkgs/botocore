...
Version  : 1.35.57
Release  : 1741
URL      : https://github.com/boto/botocore/archive/1.35.57/botocore-1.35.57.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.57/botocore-1.35.57.tar.gz
...
%prep
%setup -q -n botocore-1.35.57
cd %{_builddir}/botocore-1.35.57
pushd ..
cp -a botocore-1.35.57 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731099057
