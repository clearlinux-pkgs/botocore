...
Source0  : https://github.com/boto/botocore/archive/1.27.73/botocore-1.27.73.tar.gz
...
%prep
%setup -q -n botocore-1.27.73
cd %{_builddir}/botocore-1.27.73
pushd ..
cp -a botocore-1.27.73 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663189051
