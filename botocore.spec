...
Version  : 1.29.108
Release  : 1346
URL      : https://github.com/boto/botocore/archive/1.29.108/botocore-1.29.108.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.108/botocore-1.29.108.tar.gz
...
%prep
%setup -q -n botocore-1.29.108
cd %{_builddir}/botocore-1.29.108
pushd ..
cp -a botocore-1.29.108 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680821759
