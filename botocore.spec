...
Version  : 1.31.83
Release  : 1492
URL      : https://github.com/boto/botocore/archive/1.31.83/botocore-1.31.83.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.31.83/botocore-1.31.83.tar.gz
...
%prep
%setup -q -n botocore-1.31.83
cd %{_builddir}/botocore-1.31.83
pushd ..
cp -a botocore-1.31.83 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699574150
