...
Version  : 1.29.114
Release  : 1352
URL      : https://github.com/boto/botocore/archive/1.29.114/botocore-1.29.114.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.114/botocore-1.29.114.tar.gz
...
%prep
%setup -q -n botocore-1.29.114
cd %{_builddir}/botocore-1.29.114
pushd ..
cp -a botocore-1.29.114 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681502183
