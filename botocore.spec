...
Version  : 1.35.76
Release  : 1760
URL      : https://github.com/boto/botocore/archive/1.35.76/botocore-1.35.76.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.35.76/botocore-1.35.76.tar.gz
...
%prep
%setup -q -n botocore-1.35.76
cd %{_builddir}/botocore-1.35.76
pushd ..
cp -a botocore-1.35.76 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733366605
