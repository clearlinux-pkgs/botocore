...
Version  : 1.29.72
Release  : 1309
URL      : https://github.com/boto/botocore/archive/1.29.72/botocore-1.29.72.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.72/botocore-1.29.72.tar.gz
...
%prep
%setup -q -n botocore-1.29.72
cd %{_builddir}/botocore-1.29.72
pushd ..
cp -a botocore-1.29.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676504513
