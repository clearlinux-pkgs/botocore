...
Version  : 1.34.133
Release  : 1650
URL      : https://github.com/boto/botocore/archive/1.34.133/botocore-1.34.133.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.133/botocore-1.34.133.tar.gz
...
%prep
%setup -q -n botocore-1.34.133
cd %{_builddir}/botocore-1.34.133
pushd ..
cp -a botocore-1.34.133 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719345410
