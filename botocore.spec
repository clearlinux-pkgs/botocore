...
Version  : 1.34.88
Release  : 1605
URL      : https://github.com/boto/botocore/archive/1.34.88/botocore-1.34.88.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.88/botocore-1.34.88.tar.gz
...
%prep
%setup -q -n botocore-1.34.88
cd %{_builddir}/botocore-1.34.88
pushd ..
cp -a botocore-1.34.88 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713556312
