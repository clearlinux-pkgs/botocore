...
Source0  : https://github.com/boto/botocore/archive/1.38.26/botocore-1.38.26.tar.gz
...
%prep
%setup -q -n botocore-1.38.26
cd %{_builddir}/botocore-1.38.26
pushd ..
cp -a botocore-1.38.26 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748548358
