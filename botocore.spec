...
Version  : 1.29.45
Release  : 1282
URL      : https://github.com/boto/botocore/archive/1.29.45/botocore-1.29.45.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.45/botocore-1.29.45.tar.gz
...
%prep
%setup -q -n botocore-1.29.45
cd %{_builddir}/botocore-1.29.45
pushd ..
cp -a botocore-1.29.45 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673038351
