...
Version  : 1.29.43
Release  : 1280
URL      : https://github.com/boto/botocore/archive/1.29.43/botocore-1.29.43.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.43/botocore-1.29.43.tar.gz
...
%prep
%setup -q -n botocore-1.29.43
cd %{_builddir}/botocore-1.29.43
pushd ..
cp -a botocore-1.29.43 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672865927
