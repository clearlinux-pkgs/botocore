...
Version  : 1.29.8
Release  : 1245
URL      : https://github.com/boto/botocore/archive/1.29.8/botocore-1.29.8.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.8/botocore-1.29.8.tar.gz
...
%prep
%setup -q -n botocore-1.29.8
cd %{_builddir}/botocore-1.29.8
pushd ..
cp -a botocore-1.29.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668211020
