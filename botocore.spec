...
Version  : 1.34.130
Release  : 1647
URL      : https://github.com/boto/botocore/archive/1.34.130/botocore-1.34.130.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.130/botocore-1.34.130.tar.gz
...
%prep
%setup -q -n botocore-1.34.130
cd %{_builddir}/botocore-1.34.130
pushd ..
cp -a botocore-1.34.130 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718828282
