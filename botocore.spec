...
Version  : 1.36.26
Release  : 1802
URL      : https://github.com/boto/botocore/archive/1.36.26/botocore-1.36.26.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.36.26/botocore-1.36.26.tar.gz
...
%prep
%setup -q -n botocore-1.36.26
cd %{_builddir}/botocore-1.36.26
pushd ..
cp -a botocore-1.36.26 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740171286
