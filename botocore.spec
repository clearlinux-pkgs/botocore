...
Version  : 1.29.120
Release  : 1358
URL      : https://github.com/boto/botocore/archive/1.29.120/botocore-1.29.120.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.120/botocore-1.29.120.tar.gz
...
%prep
%setup -q -n botocore-1.29.120
cd %{_builddir}/botocore-1.29.120
pushd ..
cp -a botocore-1.29.120 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682452345
