...
Version  : 1.37.28
Release  : 1829
URL      : https://github.com/boto/botocore/archive/1.37.28/botocore-1.37.28.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.37.28/botocore-1.37.28.tar.gz
...
%prep
%setup -q -n botocore-1.37.28
cd %{_builddir}/botocore-1.37.28
pushd ..
cp -a botocore-1.37.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743796956
