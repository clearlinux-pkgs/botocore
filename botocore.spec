...
Version  : 1.29.48
Release  : 1285
URL      : https://github.com/boto/botocore/archive/1.29.48/botocore-1.29.48.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.48/botocore-1.29.48.tar.gz
...
%prep
%setup -q -n botocore-1.29.48
cd %{_builddir}/botocore-1.29.48
pushd ..
cp -a botocore-1.29.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673470649
