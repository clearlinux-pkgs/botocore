...
Version  : 1.34.111
Release  : 1628
URL      : https://github.com/boto/botocore/archive/1.34.111/botocore-1.34.111.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.111/botocore-1.34.111.tar.gz
...
%prep
%setup -q -n botocore-1.34.111
cd %{_builddir}/botocore-1.34.111
pushd ..
cp -a botocore-1.34.111 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716407678
