...
Version  : 1.29.146
Release  : 1384
URL      : https://github.com/boto/botocore/archive/1.29.146/botocore-1.29.146.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.29.146/botocore-1.29.146.tar.gz
...
%prep
%setup -q -n botocore-1.29.146
cd %{_builddir}/botocore-1.29.146
pushd ..
cp -a botocore-1.29.146 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685735415
