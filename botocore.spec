...
Version  : 1.27.52
Release  : 1182
URL      : https://github.com/boto/botocore/archive/1.27.52/botocore-1.27.52.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.27.52/botocore-1.27.52.tar.gz
...
%prep
%setup -q -n botocore-1.27.52
cd %{_builddir}/botocore-1.27.52
pushd ..
cp -a botocore-1.27.52 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660592482
