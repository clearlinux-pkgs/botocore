...
Source0  : https://github.com/boto/botocore/archive/1.32.7/botocore-1.32.7.tar.gz
...
%prep
%setup -q -n botocore-1.32.7
cd %{_builddir}/botocore-1.32.7
pushd ..
cp -a botocore-1.32.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701074862
