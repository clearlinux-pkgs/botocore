...
Version  : 1.34.67
Release  : 1584
URL      : https://github.com/boto/botocore/archive/1.34.67/botocore-1.34.67.tar.gz
Source0  : https://github.com/boto/botocore/archive/1.34.67/botocore-1.34.67.tar.gz
...
%prep
%setup -q -n botocore-1.34.67
cd %{_builddir}/botocore-1.34.67
pushd ..
cp -a botocore-1.34.67 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710966169
